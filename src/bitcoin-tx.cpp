...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " unicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  unicoin-tx [options] <hex-tx> [commands]  Update hex-encoded unicoin transaction\n" +
            "or:     unicoin-tx [options] -create [commands]   Create hex-encoded unicoin transaction\n" +
            "\n";
