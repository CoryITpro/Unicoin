...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.unicoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.unicointools.com");
        vSeeds.emplace_back("dnsseed.unicoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.unicointools.com");
        vSeeds.emplace_back("seed-b.unicoin.loshan.co.uk");
