...
const char * const BITCOIN_CONF_FILENAME = "unicoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Unicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Unicoin";
#else
    // Unix
    return pathRet / ".unicoin";
#endif
#endif
}
