# Support for Output Descriptors in Unicoin Core

Since Unicoin Core v0.17, there is support for Output Descriptors. This is a
...
on Unicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Unicoin Core wallets, a convenience function `combo` is
