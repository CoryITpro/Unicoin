Unicoin Core version *0.15.1* is now available from:

  <https://download.unicoin.org/unicoin-0.15.1/>
...
A number of changes to the way Unicoin Core deals with peer connections and invalid blocks
