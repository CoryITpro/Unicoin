...
"""Verify that starting unicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start unicoin with -h for help text")
        ...
        self.log.info("Start unicoin with -version for version information")
        ...
        self.log.info("Start unicoind with -fakearg to make sure it does not start")
